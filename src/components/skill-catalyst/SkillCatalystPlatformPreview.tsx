...
export default function SkillCatalystPlatformPreview() {
  const highlightFeatures = [
    {
      icon: TrendingUp,
      title: "Real-Time Competency Tracking",
      description: "Live feedback on capstones, case studies, and presentation drills.",
    },
    {
      icon: BarChart3,
      title: "Practical Workplace Analytics",
      description: "Measure spreadsheet, digital tool, and communication proficiency.",
    },
    {
      icon: CalendarCheck,
      title: "100% Attendance & Recorded Vault",
      description: "Catch up on live workshops anytime through archived video lessons.",
    },
    {
      icon: Award,
      title: "Verified Skill Certification",
      description: "Industry-standard shareable certificates for LinkedIn and resume.",
    },
  ];
  ...
  return (
    <section className="relative py-10 sm:py-14 bg-gradient-to-b from-white via-[#EBF7F2]/50 to-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 sm:mb-10 gap-4">
          <div className="space-y-2">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl lg:text-[44px] font-extrabold text-brand-navy leading-snug sm:leading-[1.28] lg:leading-[1.3] tracking-tight">
              ...
              <span className="text-brand-accent">for Career Preparation</span>
            </h2>
          </div>
        ...
        {/* Browser Window Mockup showcasing the Student Dashboard Image */}
        <motion.div
