        ...
        {VISIBLE_OFFSETS.map((offset) => {
          ...
          return (
            <motion.div
              ...
              className={cn(
                "rounded-[28px] sm:rounded-[32px] bg-white text-slate-900 border border-slate-200/80 shadow-[0_10px_30px_rgba(95,109,119,0.08),0_4px_12px_rgba(95,109,119,0.06)] overflow-visible",
                ...
                >
                  ...
                  >
                    <div className="flex-1 min-w-0 flex flex-col items-center md:items-start text-center md:text-left justify-between py-1 gap-2 sm:gap-3">
                      <h3
                        title={item.stat}
                        className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900 leading-tight w-full font-heading"
                      >
                        {item.stat}
                      </h3>
                      ...
                      <div className="relative w-full min-w-0 my-auto py-1">
                        <span
                          aria-hidden="true"
                          className="font-serif text-2xl sm:text-3xl lg:text-4xl text-slate-300 absolute right-full top-0 pr-1 select-none pointer-events-none hidden md:inline"
                        >
                          “
                        </span>

                        <p className="font-serif text-xs sm:text-base md:text-lg text-slate-700 leading-snug">
                          “{item.quote}”
                        </p>
                      </div>
                      ...
                      <div className="flex min-w-0 w-full max-w-full overflow-hidden items-center md:items-start justify-center md:justify-start">
                        <div className="flex flex-col items-center md:items-start min-w-0 max-w-full">
                          <span className="w-fit inline-flex items-center justify-center rounded-[4px] font-medium py-1 px-2.5 text-[11px] sm:text-xs bg-slate-100 text-slate-800 shrink-0 select-none">
                            <span className="whitespace-nowrap font-semibold">
                              {item.author}
                            </span>
                          </span>

                          <div className="shrink-0 flex items-center justify-center md:justify-start px-3 h-[6px] -my-[1px] text-slate-100 relative z-10">
                            <svg
                          ...
                          <span className="w-fit inline-flex items-center justify-center rounded-[4px] font-medium py-1 px-2.5 text-[10px] sm:text-xs bg-slate-100 text-slate-500 max-w-full select-none">
                            <span
                              title={item.role}
                              className="truncate"
                            >
                    ...
                    <div className="relative shrink-0 overflow-hidden rounded-[18px] sm:rounded-[22px] bg-slate-100 w-full md:w-[clamp(180px,44%,330px)] flex-1 md:flex-initial md:h-full max-h-[220px] md:max-h-none">
                      <Image
                        alt={item.alt || item.author}
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isSelected
                  ? "w-[80px] bg-slate-200"
                  : "w-[8px] bg-slate-200 hover:bg-slate-300"
              )}
            >
              {isSelected && (
                <div
